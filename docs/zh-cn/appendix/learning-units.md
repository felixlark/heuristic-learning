...
| U4 研究命题 | 当前证据支持哪些命题，边界在哪里？ | [研究框架](/zh-cn/theory/research-framework)、[研究命题](/zh-cn/theory/research-propositions)、[教学仓库对标](/zh-cn/appendix/course-patterns) | `npm run claims:registry:check`、`npm run patterns:check` | 命题-证据-反驳路径说明 |
