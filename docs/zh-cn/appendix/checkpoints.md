...
本页给学生、助教和编码智能体一个更细的学习验收入口。学习单元回答“读什么、跑什么、交付什么”，学习成果回答“最终会什么”，阶段检查点回答“这一段学完怎么判断自己真的会了”。
...
| CP2 公开来源自测 | U2 | 能否区分公开 artifact、X 线索和待采集来源？ | `npm run source:registry:check` |
...
2. 如果学生只跑通命令，但无法解释 `pass_condition` 中的证据链，不能判定通过。
