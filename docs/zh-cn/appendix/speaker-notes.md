...
| 第 2 讲讲者备注 | 一条来源怎样转成可验证实验而不过度声明？ | source status、case card、轻量 replay 边界 | 提交一张 case card 草稿 |
...
3. 如果课堂讨论产生新案例，先进入 [来源登记](/zh-cn/appendix/source-registry) 或 [案例矩阵](/zh-cn/appendix/case-registry)，等有稳定 probe、运行命令和验证结果后再写成已复现。
