...
这门中文 Web 课程面向开发者和 AI 爱好者。它不要求强化学习背景，也不把 HL 讲成已经成熟的理论，而是通过通俗解释、可运行代码和公开实验，把它整理成一个可学习、可复现、可讨论的研究主题：
...
想快速建立全貌，可以先看 [一小时导读](/zh-cn/talk/)；希望系统学习，则按下面的顺序继续。
...
| 3. 跑通示例 | [可运行示例](/zh-cn/examples/) 与 [Lab 1](/zh-cn/examples/) | 运行 GridWorld 和 feedback report | 一份实验记录 |
| 4. 阅读案例 | [案例库](/zh-cn/cases/) 与 [来源登记](/zh-cn/appendix/source-registry) | 区分已复现、轻量 replay 和待验证线索 | 一张 case card |
| 5. 修改验证 | [代码导览](/zh-cn/appendix/code-tour) 与 [Lab 2](/zh-cn/theory/learning-loop) | 只改一个策略点，再跑测试和报告 | anti-forgetting checklist |
| 6. 研究进阶 | [真实环境 Benchmark](/zh-cn/benchmark/) 与 [研究框架](/zh-cn/theory/research-framework) | 用隔离种子和追加式账本评估策略 | 一个可反驳研究问题 |
...
7. 完成 [Lab 1](/zh-cn/examples/) 和 [Lab 2](/zh-cn/theory/learning-loop)：把一次 heuristic update 写成可验证记录。
...
学习 HL 时始终追问三个问题：反馈是什么，更新了什么，怎样证明新修改没有破坏旧能力。
