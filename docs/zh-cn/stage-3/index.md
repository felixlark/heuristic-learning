...
再进一步，可以阅读 [研究框架](/zh-cn/theory/research-framework) 和 [研究命题](/zh-cn/theory/research-propositions)，把案例写成“主张 -> 证据 -> 反例 -> 下一步实验”的形式。当前仓库中的轻量 replay 只能支持教学型假设，不能直接写成高保真复现实验结论。
