...
routes=(
  ...
  "/heuristic-learning/zh-cn/slides/"
  "/heuristic-learning/zh-cn/appendix/reading-guide"
  "/heuristic-learning/zh-cn/appendix/course-patterns"
  ...
  "/heuristic-learning/teaching-registry.json"
  "/heuristic-learning/teaching-registry.schema.json"
  "/heuristic-learning/slide-deck.json"
  "/heuristic-learning/slide-deck.schema.json"
  "/heuristic-learning/speaker-notes.json"
  "/heuristic-learning/speaker-notes.schema.json"
  ...
  "/heuristic-learning/course-patterns.json"
  "/heuristic-learning/course-patterns.schema.json"
